...
class MetaCIFAR100(CIFAR100):
    ...
    def __init__(self,
                 ...
                 test_transform=None,
                 fix_seed=True):
        super(MetaCIFAR100, self).__init__(args, partition=partition, pretrain=False)
...
if __name__ == '__main__':
    args = lambda x: None
    args.data_root = json.load(open('config.json'))['CIFAR-FS']
    args.n_ways = 5
    args.n_shots = 1
    args.n_queries = 12
    args.data_aug = True
    ...
    metaimagenet = MetaCIFAR100(args, 'val')
