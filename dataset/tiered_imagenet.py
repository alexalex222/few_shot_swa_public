...
class MetaTieredImageNet(TieredImageNet):
    ...
    def __init__(self, args, partition='train', train_transform=None, test_transform=None, fix_seed=True):
        super(MetaTieredImageNet, self).__init__(args, partition=partition, pretrain=False)
...
if __name__ == '__main__':
    ...
    args.n_shots = 1
    args.n_queries = 12
    args.data_root = json.load(open('config.json'))['tieredImageNet']
    args.data_aug = True
    args.n_test_runs = 5
    ...
    metaimagenet = MetaTieredImageNet(args, 'val')
